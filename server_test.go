...
func TestHelloWorldShouldSucceed(t *testing.T) {
	testServer := httptest.NewServer(http.HandlerFunc(handleHellowWorld))
...
func TestHandleHealthShouldSucceed(t *testing.T) {
...
func TestHandleHealthShouldFail(t *testing.T) {
	testServer := httptest.NewServer(http.HandlerFunc(handleHealth))
	defer testServer.Close()
...
func TestHandleNewEndpointShouldSucceed(t *testing.T) {
...
func TestHandleNewpointShouldFail(t *testing.T) {
	testServer := httptest.NewServer(http.HandlerFunc(handleNewEndpoint))
	defer testServer.Close()
